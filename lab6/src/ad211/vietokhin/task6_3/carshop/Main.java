package ad211.vietokhin.task6_3.carshop;
...
import ad211.vietokhin.task6_3.carshop.impl.MyOwnAutoShop;
...
public class Main {
    ...
    public static void inputCarsInfo(MyOwnAutoShop shop) {
        ...
        for (int i=0; i<shop.getCars().length; i++) {
            ...
            } else if (shop.getCars()[i] instanceof Truck) {
                System.out.println("Input weight:");
                weight=scanner.nextInt();

                shop.getCars()[i] = new Truck(speed, false, price, color, weight);
            }
        }
    }
